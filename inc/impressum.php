...
<div class="container impressum col-10">
    ...
    <p>
        <b>Unternehmensgegenstand:</b> IT Dienstleistungen
        <br>
        <b>UID-Nummer:</b> ATU12345678
    </p>
    <p>
        <b>Tel.:</b> 01234/56789
        <br>
        <b>Fax:</b> 01234/56789-0
        <br>
        <b>E-Mail:</b> <a href="mailto:office@karanatsch.com">office@karanatsch.com</a>
    </p>
    <p>
        <b>Mitglied bei:</b> WKO, Landesinnung, etc.
        <br>
        <b>Berufsrecht:</b> Gewerbeordnung: www.ris.bka.gv.at
    </p>
    <p>
        <b>Aufsichtsbehörde/Gewerbebehörde:</b> Bezirkshauptmannschaft Wien
        <br>
        <b>Berufsbezeichnung:</b> Webdesigner
        <br>
    ...
    <p>
        ...
        Kommission unter http://ec.europa.eu/odr?tid=221139770 zu richten. Die dafür notwendigen Kontaktdaten finden Sie
    ...
    <p>
        Sollten Ihnen problematische oder rechtswidrige Inhalte auffallen, bitten wir Sie uns umgehend zu kontaktieren,
    ...
    <p>
        ...
        <a href="https://www.ris.bka.gv.at/Dokument.wxe?Abfrage=Bundesnormen&amp;Dokumentnummer=NOR40025813&amp;tid=221139770">§
            17 ECG</a>
        für uns nicht, da wir keine Kenntnis rechtswidriger Tätigkeiten hatten und haben, uns solche Rechtswidrigkeiten
        auch bisher nicht aufgefallen sind und wir Links sofort entfernen würden, wenn uns Rechtswidrigkeiten bekannt
        werden.
    </p>
    <p>
    ...
    <ul>
        <li><a href="https://de.freelogodesign.org/">FreeLogoDesigns</a></li>
    </ul>
    <h1>Datenschutzerklärung</h1>
    <h2>Datenschutz</h2>
    <p>
        Wir haben diese Datenschutzerklärung (Fassung 16.01.2021-221139770) verfasst, um Ihnen gemäß der Vorgaben der
        Datenschutz-Grundverordnung (EU) 2016/679 zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden
    ...
    <p>
        In der Regel werden Webserver-Logfiles zwei Wochen gespeichert und danach automatisch gelöscht. Wir geben diese
    ...
    <p>
        ...
        gibt. HTTP-Cookies sind kleine Dateien, die von unserer Webseite auf Ihrem Computer gespeichert werden. Diese
    ...
    <p>
        ...
        Informationen an unsere Seite zurück. Dank der Cookies weiß unsere Webseite, wer Sie sind und bietet Ihnen die
    ...
    <p>
        <b>Name:</b> _ga
        <br>
        <b>Wert:</b> GA1.2.1326744211.152221139770-6
        <br>
        <b>Verwendungszweck:</b> Unterscheidung der Webseitenbesucher
        <br>
    ...
    <p>
        <b>Unerlässliche Cookies</b>
        <br>
        Diese Cookies sind nötig, um grundlegende Funktionen der Webseite sicherzustellen. Zum Beispiel braucht es diese
        Cookies, wenn ein User ein Produkt in den Warenkorb legt, dann auf anderen Seiten weitersurft und später erst
        zur Kasse geht. Durch diese Cookies wird der Warenkorb nicht gelöscht, selbst wenn der User sein Browserfenster
        schließt.
    </p>
    <p>
        <b>Zweckmäßige Cookies</b>
        <br>
    ...
    <p>
        Üblicherweise werden Sie beim erstmaligen Besuch einer Webseite gefragt, welche dieser Cookiearten Sie zulassen
    ...
    <p>
        <a class="adsimple-221139770" href="https://support.google.com/chrome/answer/95647?tid=221139770">Chrome:
            Cookies in Chrome löschen, aktivieren und verwalten</a>
    </p>
    <p>
        <a class="adsimple-221139770" href="https://support.apple.com/de-at/guide/safari/sfri11471/mac?tid=221139770">Safari:
            Verwalten von Cookies und Websitedaten mit Safari</a>
    </p>
    <p>
        <a class="adsimple-221139770"
           href="https://support.mozilla.org/de/kb/cookies-und-website-daten-in-firefox-loschen?tid=221139770">Firefox:
            Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a>
    </p>
    <p>
        <a class="adsimple-221139770"
           href="https://support.microsoft.com/de-at/help/17442/windows-internet-explorer-delete-manage-cookies?tid=221139770">Internet
            Explorer: Löschen und Verwalten von Cookies</a>
    </p>
    <p>
        <a class="adsimple-221139770"
           href="https://support.microsoft.com/de-at/help/4027947/windows-delete-cookies?tid=221139770">Microsoft Edge:
    ...
    <p>
        ...
        <a class="adsimple-221139770" href="https://tools.ietf.org/html/rfc6265">https://tools.ietf.org/html/rfc6265</a>,
    ...
    <p>
        Wir nutzen Ihre persönlichen Daten somit nur für die Kommunikation mit jenen Besuchern, die Kontakt ausdrücklich
        wünschen und für die Abwicklung der auf dieser Webseite angebotenen Dienstleistungen und Produkte. Wir geben
        Ihre persönlichen Daten ohne Zustimmung nicht weiter, können jedoch nicht ausschließen, dass diese Daten beim
        Vorliegen von rechtswidrigem Verhalten eingesehen werden.
    </p>
    <p>
        Wenn Sie uns persönliche Daten per E-Mail schicken – somit abseits dieser Webseite – können wir keine sichere
    ...
    <p>
        Ihnen stehen laut den Bestimmungen der DSGVO und des österreichischen Datenschutzgesetzes (DSG) grundsätzlich
    ...
    <p>
        Google Fonts (früher Google Web Fonts) ist ein Verzeichnis mit über 800 Schriftarten, die Google Ihren Nutzern
    ...
    <p>
        Mit Google Fonts können wir auf der eigenen Webseite Schriften nutzen, und müssen sie nicht auf unserem eigenen
    ...
    <p>
        ...
        <a class="adsimple-221139770" href="https://support.google.com/?hl=de&amp;tid=221139770">https://support.google.com/?hl=de&amp;tid=221139770</a>
    ...
    <p>
        ...
        <a class="adsimple-221139770" href="https://developers.google.com/fonts/faq?tid=221139770">https://developers.google.com/fonts/faq?tid=221139770</a>.
    ...
    <p>
        ...
        <a class="adsimple-221139770" href="https://policies.google.com/privacy?hl=de&amp;tid=221139770">https://www.google.com/intl/de/policies/privacy/</a>
        nachlesen.
    </p>
    <h2>BootstrapCDN Datenschutzerklärung</h2>
    <p>
        Um Ihnen all unsere einzelnen Webseiten (Unterseiten unserer Website) auf allen Geräten schnell und sicher
        ausliefern zu können, nutzen wir das Content Delivery Network (CDN) BootstrapCDN des amerikanischen
        Software-Unternehmens StackPath, LLC 2012 McKinney Ave. Suite 1100, Dallas, TX 75201, USA.
    </p>
    <p>
        Ein Content Delivery Network (CDN) ist ein Netzwerk regional verteilter Server, die über das Internet
        miteinander verbunden sind. Durch dieses Netzwerk können Inhalte, speziell sehr große Dateien, auch bei großen
        Lastspitzen schnell ausgeliefert werden.
    </p>
    <p>
        BootstrapCDN funktioniert so, dass sogenannte JavaScript-Bibliotheken an Ihren Browser ausgeliefert werden. Lädt
        nun Ihr Browser eine Datei vom BootstrapCDN herunter, wird Ihre IP-Adresse während der Verbindung zum
        Bootstrap-CDN-Server an das Unternehmen StockPath übermittelt.
    </p>
    <p>
        StackPath erwähnt auch in der hauseigenen Datenschutzerklärung, dass das Unternehmen aggregierte und
        anonymisierte Daten von diversen Diensten (wie BootstrapCDN) für die Erweiterung der Sicherung und für andere
        StackPath-Dienste und Clients verwenden. All diese Daten können aber keine Person identifizieren.
    </p>
    <p>
        Wenn Sie diese Datenübertragung unterbinden wollen, können Sie einen JavaScript-Blocker (siehe beispielsweise
        <a class="adsimple-221139770" href="https://noscript.net/">https://noscript.net/</a>)
        installieren oder in Ihrem
        Browser die Ausführung von JavaScript-Codes deaktivieren.
        Bitte beachten Sie aber, dass dadurch die Website nicht mehr das gewohnte Service (wie etwa schnelle
        Ladegeschwindigkeit) bieten kann.
    </p>
    <p>
        StackPath ist aktiver Teilnehmer beim EU-U.S. Privacy Shield Framework, wodurch der korrekte und sichere
        Datentransfer persönlicher Daten geregelt wird. Mehr Informationen dazu finden Sie auf
        <a class="adsimple-221139770"
           href="https://www.privacyshield.gov/participant?id=a2zt0000000CbahAAC&amp;status=Active">https://www.privacyshield.gov/participant?id=a2zt0000000CbahAAC&amp;status=Active</a>.
    </p>
    <p>
        Mehr Informationen zum Datenschutz bei StackPath bzw. BootstrapCDN finden Sie auf
        <a class="adsimple-221139770" href="https://www.bootstrapcdn.com/privacy-policy/?tid=221139770">https://www.bootstrapcdn.com/privacy-policy/</a>.
    </p>
    <p>
        Quelle: Erstellt mit dem
        <a title="Datenschutz Generator von firmenwebseiten.at"
           href="https://www.firmenwebseiten.at/datenschutz-generator/"">Datenschutz Generator</a>
        von firmenwebseiten.at in Kooperation mit
        <a href="https://www.urlaubsnews.at">urlaubsnews.at</a>
    </p>
    <br>
</div>